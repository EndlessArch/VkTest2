...
private:
    ...
    void drawFrame() {
        ...
        submitInfo.waitSemaphoreCount = std::extent_v<decltype(waitStages)>;
        ...
        submitInfo.signalSemaphoreCount = std::extent_v<decltype(signalSemaphores)>;
        ...
        presentInfo.swapchainCount = std::extent_v<decltype(swapChains)>;
